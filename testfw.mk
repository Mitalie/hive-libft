...
#    Updated: 2024/07/05 18:18:59 by amakinen         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ifeq ($(shell uname -s),Linux)
    ...
    $(OBJDIR)/test/testfw/mock_write.o: tgt_CPPFLAGS += -D_GNU_SOURCE
    # strlcpy and strlcat don't exist in glibc before 2.38, use libbsd
    $(OBJDIR)/test/base/strl.o: tgt_CPPFLAGS += -DLIBBSD_OVERLAY -isystem /usr/include/bsd
    # strnstr doesn't exist in glibc, use libbsd
    $(OBJDIR)/test/base/strnstr.o: tgt_CPPFLAGS += -DLIBBSD_OVERLAY -isystem /usr/include/bsd
